                    ...
                    <div class="col-md-4">
                        <div class="card bg-light border-0">
                            <div class="card-body">
                                ...
                                <p><strong>Submitted by:</strong><br><?= htmlspecialchars($ticket['email'] ?? '—') ?>
                                </p>
                ...
                <form method="post" class="mt-4">
                    <div class="row g-3">
                        <div class="col-md-4">
                            ...
                            <select name="status" class="form-select">
                                ...
                                <option value="on_hold" <?= ($ticket['status'] ?? '') === 'on_hold' ? 'selected' : '' ?>>On
                                    Hold</option>
                    ...
                    <div class="mt-3">
                        ...
                        <textarea name="note" class="form-control" rows="3"
                            placeholder="Add internal comments or next steps..."></textarea>
                    </div>
